...
export default class FlightStatusChaincode extends Chaincode {
	...
	const iataCode = CertificateHelper.getIataCode(stubHelper.getClientIdentity());
        ...
        FlightChainLogic.verifyAbleToCreateOrModifyFlight(flight.operatingAirline.iataCode, flight);
    ...
    async queryAllFlightStatus(stubHelper: StubHelper): Promise<any> {
