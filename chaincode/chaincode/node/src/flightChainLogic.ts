...
export class FlightChainLogic {
    ...
    static verifyValidACRIS(flight: AcrisFlight): void {
          ...
          console.log("flight.operatingAirline", flight.operatingAirline);
   ...
   console.log("flight.departureAirport", flight.departureAirport);
      ...
      console.log("flight.arrivalAirport", flight.arrivalAirport);
...
console.log("flightNumber.trackNumber", flight.flightNumber.trackNumber);
    ...
    public static verifyAbleToCreateOrModifyFlight(iata_code: string, flight: AcrisFlight): void {
        ...
        if (this.isAirline(iata_code)) {
            ...
            if (iata_code.toUpperCase() !== departureAirport.toUpperCase() &&
                ...
                const msg = `The iata airport code ${iata_code} does not match the departure ` +
