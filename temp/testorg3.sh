...
# Invoke chaincode on peer0.airline, peer0.airport, and peer0.org3
echo "Sending invoke transaction on peer0.airline peer0.airport peer0.org3..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.org3, peer0.airport, peer0.airline check if the result is 80
...
echo "Querying chaincode on peer0.airport..."
