...
# on peer0.airline and peer0.airport, and uprage the chaincode on the
...
echo "===================== Installing chaincode 2.0 on peer0.airline ===================== "
installChaincode 0 1 2.0
echo "===================== Installing chaincode 2.0 on peer0.airport ===================== "
installChaincode 0 2 2.0

echo "===================== Upgrading chaincode on peer0.airline ===================== "
